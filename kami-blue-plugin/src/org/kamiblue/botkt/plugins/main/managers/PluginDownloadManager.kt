...
object PluginDownloadManager : Manager {
    ...
    init {
        asyncListener<MessageReceiveEvent> { event ->
            ...
            val attachments = if (!event.message.attachments.isEmpty()) pluginMsg.attachments else return@asyncListener
            ...
            val attachment = attachments.find { it.filename == fileName } ?: return@asyncListener
